...
$$
BEGIN
	IF register_patch('AddRorIdToInstitutions.sql', 'jekabskarklins', 'Add ror id to institutions', '2023-12-19') THEN
	BEGIN

        ALTER TABLE institutions
		ADD ror_id VARCHAR(30) UNIQUE;
		...
		DELETE FROM institutions where ror_id is null AND institution != 'Other';
